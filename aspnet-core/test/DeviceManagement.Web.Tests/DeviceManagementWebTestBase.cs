...
{
    public abstract class DeviceManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DeviceManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DeviceManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DeviceManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DeviceManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DeviceManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DeviceManagementDbContext, Task<T>> func)
        {
            T result;
